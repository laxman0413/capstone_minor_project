...
def detect_pii(image_path):
    model_path = os.path.join(os.path.dirname(__file__), "pan.pt")
    ...
    class_names = ['dob', 'emblem', 'fatherName', 'goi', 'income tax', 'name', 'overallStructure', 'panCard', 'photo', 'signature']

    # Define the PII fields that need to be masked
    pii_classes = ['dob', 'fatherName', 'name', 'panCard', 'signature']
